...
//
///**
// * Customization naming of JPA entities.
// *
// * @author bacnguyen <br>
// * @version 1.0 <br>
// * @see #{@link org.hibernate.boot.model.naming.PhysicalNamingStrategy}
// * @see #
// *      {@link org.hibernate.boot.model.naming
...
//            LOGGER.debug("Class[{}] is converted to table[{}]"
//                    , name.getText(), txt);
//        }
...
//        String txt = addUnderscores(name.getText());
//        if (LOGGER.isDebugEnabled()) {
//            LOGGER.debug("Class property[{}] is converted to column[{}]"
//                    , name.getText(), txt);
//        }
//        return new Identifier(txt, name.isQuoted());
//    }
